 ...
 * Inha Joo
 *
 * Card.cpp - represents a card
 *
 * This class represents a card in the game.  It has no dynamically
 * allocated data members, so the default copy and assignment
 * constructors are used.  Several constructors are provided to
 * create:
 *   * blank card
 *   * card with a specified value
 *   * card entered by the user (a string)
 *
 * The class also defines operators for comparison and order.
 */
