 ...
 * Inha Joo
 *
 * Round.cpp - represents a round of play
 *
 * Keeps track of card piles and loops through turns.  The computer's
 * AI algorithm is implemented here.  Also turn input from the user
 * is handled.  A round ends when a player's hand becomes empty.
 */
...
void Round::userTakesTurn()
{
	...
	while (!userHand_.isEmpty())
	{
		...
		// About
            ...
            << "King's Corner by Inha Joo" << endl
			...
			<< endl
            << "Inha Joo is a senior at the University of Illinois at Chicago.  He" << endl;
