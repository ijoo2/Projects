 ...
 * Inha Joo
 *
 * Game.cpp - represents a single game of King's Corner
 *
 * Loops through rounds, creating Round objects and playing them.
 * Keeps cumulative penalty points for each player, ending the
 * game when one player reaches 25, and announcing the winner.
 */
